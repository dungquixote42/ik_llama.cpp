...
struct llama_sampler_adaptive_p * llama_init_adaptive_p(int n_vocab, const float target, const float decay, const bool use_cur_p, const uint32_t seed) {
    return llama_init_adaptive_p_impl(n_vocab, target, decay, use_cur_p, seed);
}
